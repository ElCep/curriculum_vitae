...
\cvsubsection{Co-encadrement de doctorant permanent}
\vspace{1em}

\begin{cventries}
  \cventry
    {Anna Ndiaye} % Affiliation/role
    {Mobilité pastorale, et modélisation d'accompagnement - repenser l'espace } % title de la thèse
    {ENSA, Thies, Sénégal} % Location
    {2024-2027} % Date(s)
    {
...
\cventry
  ...
  {Évaluation territoriale du rôle de l’intégration agriculture-élevage dans la séquestration du carbone par les sols cultivés en Afrique de l’Ouest} % title de la thèse
  {MUSE, Montpellier, France} % Location
  {2021-2024} % Date(s)
  {
    \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
\vspace{2em}
\cvsubsection{Encadrement ponctuel de doctorant}
\vspace{1em}
%-------------------------------------------------------------------------------
%	CONTENT
%-------------------------------------------------------------------------------
\begin{cventries}
  ...
  %---------------------------------------------------------
    \cventry
      {Catherine Mané} % Affiliation/role
      {Modélisation de la capacité d’adaptation du monde rural face
      aux impacts du changement climatique} % title de la thèse
      {UCAD, Dakar, Sénégal} % Location
      {2024-2027} % Date(s)
      {
        \begin{cvitems} % Description(s) of experience/contributions/knowledge
    ...
    \cventry
      ...
      {
        \begin{cvitems} % Description(s) of experience/contributions/knowledge
         Impacte de l'intégration agriculture élevage dans le bassin arrachider au Sénégal. Approche de modélisation, simulation et exploration. Thèse financé par le projet 3F, fondation McKnight.\\
...
%-------------------------------------------------------------------------------
  \cventry
      {Dame Thiaw} % Affiliation/role
      {Application de la théorie de la viabilité à la modélisation d’une ferme agroécologique : étude de cas de la ferme agro-éco-lieutique} % title
      {UCAD - Sénégal} % Location
      {Septembre -Décembre 2024} % Date(s)
      {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        Analyse, à l’aide de la théorie de la viabilité, les conditions de durabilité des systèmes agricoles irrigués autour du lac de Guiers en modélisant les interactions entre biomasse, fertilité des sols, disponibilité en eau et capital économique. Identifier des trajectoires et des stratégies agroécologiques capables de concilier productivité agricole, viabilité économique des exploitations et préservation à long terme des ressources hydriques et pédologiques dans un contexte de forte pression environnementale.\\
      \end{cvitems}
      }
%-------------------------------------------------------------------------------
  \cventry
      {Daouda Ndiaye} % Affiliation/role
      {Viabilité alimentaire et pastoralisme au Sénégal :une approche par la théorie de la viabilité} % title
      {UCAD - Sénégal} % Location
      {Septembre -Décembre 2024} % Date(s)
      {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        analyser la viabilité du système pastoral sénégalais en comparant, à l’aide de la théorie de la viabilité, les trajectoires d’un élevage extensif fondé sur la mobilité et celles d’un élevage intensif plus sédentaire, sous contraintes écologiques, économiques et sociales.\\
      \end{cvitems}
      }

%-------------------------------------------------------------------------------
  \cventry
      {Osmane Faye} % Affiliation/role
      {Construction d'une typologie vectorielle du parcellaire du village de Diohine par apprentissage profond} % title
      {ISI - Sénégal} % Location
      {Septembre -Décembre 2024} % Date(s)
      {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%---------------------------------------------------------   
  \cventry
      {Emilie Fievet} % Affiliation/role
      {L’attachement aux arbres et aux lieux : comprendre le relation entre les humains, les espaces et les arbres} % title
      {MHN - Paris} % Location
      {Mars -Septembre 2024} % Date(s)
      {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
    ...
    \cventry
        ...
        {Gouverner les efforts de pêche : Viabilité de la pêche continentale dans le lac de Guiers} % title
        {UCAD } % Location
        {Aout - Decembre 2024} % Date(s)
        {
        \begin{cvitems} % Description(s) of experience/contributions/knowledge
    ...
    \cventry
        ...
        {Studying the socio-spatial dynamics and organizational rules in Lake Guiers' region, Senegal : For the mobilization of two living labs in the frame of the "Santés et Territoires" project} % title
        {Purpan, Toulouse /  Ås, Norway} % Location
    ...
    \cventry
        ...
        {Ecole Polytechnique, Dakar} % Location
    ...
    \cventry
        {Lucas Broutin} % Affiliation/role
        {Reflexion géographie pour une exploration d'accompagnement ; quelle concertation pour Diohine (Sénégal)} % title
        {Master 1 GAED, Nanterre, Paris, FR} % Location
        {Févrer - Aout 2022} % Date(s)
        {
        \begin{cvitems} % Description(s) of experience/contributions/knowledge
